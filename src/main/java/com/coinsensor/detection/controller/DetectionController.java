...
public class DetectionController {
	...
	@GetMapping
	public ResponseEntity<ApiResponse<List<DetectionInfoResponse>>> getDetectionInfos(
		@RequestParam String exchange,
		@RequestParam String exchangeType,
		@RequestParam String coinCategory,
		@RequestParam String timeframe) {
		return ApiResponse.createSuccess(
			detectionService.getDetectionInfos(exchange, exchangeType, coinCategory, timeframe));
	}

	@GetMapping("/chart")
	public ResponseEntity<ApiResponse<DetectionChartResponse>> getDetectionChart(
		@RequestParam String timeframe,
		@RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime startTime,
		@RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime endTime) {
		return ApiResponse.createSuccess(detectionService.getDetectionChart(timeframe, startTime, endTime));
	}
}